...
const {addVisit,visitSummary,id,filters,verifyOtp,sendOtp,getPendingVisitAnalytics, getAllVisitAlert, visitComment, getDisabledTime} = require("../validation/visit.js");
...
router.get("/getDisabledTime",authentication,validator.query(getDisabledTime),visitController.getDisabledTime);
