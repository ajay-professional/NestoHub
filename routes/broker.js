...
const { sendOtp, verifyOtp, registerName, registerFromReferal, updatePersonalInfo, updateBankInfo, updatePreferences, filters, id, addBroker, updateBroker } = require('../validation/broker');
...
router.post('/addBroker', validator.body(addBroker), brokerController.addBroker);
router.put('/updateBroker', validator.body(updateBroker), brokerController.updateBroker);
